  ...
  template: `
    @if (service(); as s) {
              ...
              <div class="lg:max-w-lg">
                ...
                <nav aria-label="Breadcrumb" class="mb-4">
                  <ol class="flex items-center gap-2 text-sm text-zinc-500">
                    ...
                    <li class="text-zinc-900 dark:text-white">{{ s.title }}</li>
                  </ol>
                </nav>
            ...
            >
              ...
              >
                <div class="text-sky-500">
                  @if (s.icon === 'code') {
                    <svg class="w-32 h-32" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1">
            ...
            <div class="lg:pr-4">
              ...
              >
                <ul role="list" class="space-y-6 text-zinc-600 dark:text-zinc-400">
                  @for (feature of s.details.features; track $index) {
                ...
                <div class="mt-10 flex flex-col gap-2">
                  <a
                    routerLink="/contact"
                    class="inline-flex w-fit rounded-md bg-sky-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-sky-500 transition-colors"
                  >
                    {{ s.details.cta }}
                  </a>
      ...
      <div class="py-32 text-center">
        <p class="text-zinc-500 mb-4">Servicio no encontrado.</p>
        <a routerLink="/services" class="text-sky-500 hover:underline text-sm">← Ver todos los servicios</a>
      </div>
    }
  `,
})
export class ServiceDetail {
  ...
  service = computed(() =>
    this.settings.text().services.items.find((s) => s.slug === this.slug)
  );
