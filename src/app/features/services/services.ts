    ...
    <section class="py-24 sm:py-32">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center mb-16">
          <p class="text-base font-semibold leading-7 text-sky-500 uppercase tracking-widest">
        ...
        <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
            @for (service of settings.text().services.items; track service.slug) {
              <div
              ...
              >
                ...
                <dd class="mt-4 flex flex-auto flex-col text-zinc-600 dark:text-zinc-400">
                  <p class="flex-auto text-sm leading-relaxed">{{ service.desc }}</p>
                  @if (service.use_case) {
                    <p
...
export class Services {
  ...
  constructor() {
    this.seo.updateSeo({
      title: 'Servicios de Desarrollo Web, IA y SaaS en México | JH Dev Agency',
      description:
        'Agencia de desarrollo web en México. Creamos sitios rápidos, automatización con IA y productos SaaS para negocios que quieren crecer.',
      keywords:
        'desarrollo web mexico, agencia desarrollo web puebla, automatizacion ia negocios, desarrollo saas mexico',
      url: 'https://jhdevagency.com/services',
    });

    this.schema.setSchema('Service', {
      serviceType: 'Desarrollo Web y Software',
      name: 'Servicios de Desarrollo Web, IA y SaaS',
      provider: {
        '@type': 'Organization',
        name: 'JH Dev Agency',
